    ...
    <Tab.Navigator {...tabProps}>
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({  }: { color: string, size: number }) => (
            // Your icon component or implementation goes here          
            <Icon
              name="receipt-long"
              color={"color"}
              size={"size"}
      ...
      <Tab.Screen
        ...
        options={{
          ...
          <Icon
          name="inventory"
          color={color as string} // Explicitly cast 'color' as string
          size={size as number} // Explicitly cast 'size' as number
          />
        />
      ),
    </Tab.Navigator>
